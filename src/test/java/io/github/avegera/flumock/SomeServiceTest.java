...
class SomeServiceTest {
    ...
    private static final boolean TEST_BOOLEAN_RESULT = true;
    ...
    void testSomeMethod() {
        ...
        doReturn(TEST_BOOLEAN_RESULT).when(service4).fourthMethod(TEST_GENERATED_ID);
    ...
    void enrichedTestSomeMethod() {
        ...
        String result = executionOf(() -> service.someMethod(TEST_ARG_1, TEST_ARG_2))
                .shouldInvoke(service1).voidMethod(s -> s.firstMethod(TEST_ARG_1))
                .thenInvoke(service2).voidMethod(Service2::secondMethod)
                .thenInvoke(service3).method(s -> s.thirdMethod(TEST_ARG_1, TEST_ARG_2)).thatReturn(TEST_GENERATED_ID)
                .thenInvoke(service4).method(s -> s.fourthMethod(TEST_GENERATED_ID)).thatReturn(TEST_BOOLEAN_RESULT)
                .thenReturnResult();
    ...
    void enrichedTestSomeMethod2() {
        ...
        String result = executionOf(() -> service.someMethod2(TEST_ARG_1, TEST_ARG_2))
                .shouldInvoke(service3)
                    .method(s -> s.thirdMethod(TEST_ARG_1, TEST_ARG_2)).thatReturnNull()
                .thenInvoke(service4)
                    .method(s -> s.fourthMethod(null)).thatReturn(TEST_BOOLEAN_RESULT)
                .thenInvoke(service1)
                    .voidMethod(s -> s.firstMethod(TEST_ARG_1))
